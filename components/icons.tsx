...
export const LoadingSpinner = () => (
    <svg className="animate-spin h-5 w-5 text-high-contrast-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
